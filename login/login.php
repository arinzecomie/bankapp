...
include('../library/library.php');
 ...
 if(isset($_POST['login_submit'])){
	...
	if($validation->return_passed() == true ){
		...
		$table_name = "users";
		$query_fields = array("field_names"=>array("username", "bitcoin_w" ), "where"=>array("username =", "AND password ="), "data"=>$validation->return_valid_data(), "limit"=>1);
            ...
            <div class="row">
                <div class="col-lg-6" >
                    <div class="contact-form" style="background-color:#ffffff;">
                        ...
                        <form action="../login/?a_rqs=account" method="post">
                            <div class="row">
                                <div class="col-12">
                                    <span class="input_desc"> Username</span><br>
<input class="input_main" id="username" type="text" name="username" required="required"/>
                                </div>
                                <div class="col-12">
<span class="input_desc">Password</span><br>
